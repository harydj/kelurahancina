             ...
             <table id="example1" class="table table-bordered table-striped">
               ...
               <tr>
                 ...
                 <td><center>
                                ...
                                <a class='btn btn-info btn-xs' title='Edit Data' href='<?php echo base_url()."Kettdkmampu/post"?>'><span class='glyphicon glyphicon-edit'></span></a>
                    ...
                    <div class="box-body pad">
                      ...
                      <div class="col-md-14">
                        ...
                        <div class="form-group col-md-11">
                            ...
                            <div class="col-sm-7">
                            <input id="maksud" class="form-control" type="text" placeholder="Masukkan Tujuan Surat e.g. Melamar Kerja,.." required>
                          </div>
                        </div>

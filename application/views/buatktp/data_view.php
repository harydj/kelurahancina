          ...
          <div class="nav-tabs-custom">
           ...
           <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
               ...
               <tr>
                 ...
                 <td><center>
                                <a class='btn btn-info btn-xs' title='Edit Data' href='<?php echo base_url()."Pembuatanktp/post/".$row->nik;?>'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-success btn-xs' title='Print' href='<?php echo base_url()."Pembuatanktp/create_pdf/".$row->nik;?>'><span class='glyphicon glyphicon-print'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo base_url()."Pembuatanktp/delete_by_id/".$row->nik;?>'><span class='glyphicon glyphicon-remove'></span></a>
                      </center>
                 </td>
               </tr>
               <?php } ?>s
           ...
           <!-- /.box-body -->
              ...
              <div class="tab-pane" id="tab_2">
                <form method="post" action="<?php echo base_url()."Pembuatanktp"?>/simpan">
                    ...
                    <div class="box-body pad">
                      ...
                      <div class="col-md-14">
                        ...
                        <div class="form-group col-md-11">
                            ...
                            <div class="col-sm-7">
                            <input id="nik" name="nik" class="form-control" type="number" placeholder="Masukkan NIK Pemohon" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group col-md-11">
                            ...
                            <br><small>KCN/</small><small>{{getMessage}}</small><small>/2/2017</small>
                          </div>
                        </div>

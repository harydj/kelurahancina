      ...
      <div class="form-horizontal">
        <div class="box-body">
          <div class="row">
            <br>
            <div class="col-md-14">
              <form id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url()."Mutasipndh/update/".$row->nik;?>">
              <!-- Data diri -->
              <div class="form-group col-md-11">
                ...
                <div class="col-sm-7" id="app">
                  ...
                  <small>KCN/</small><small>{{<?php echo $row->no_surat; ?>}}</small><small>/2/2017</small>
                </div>
              </div>
              <div class="form-group col-md-11">
                  <label for="nama" class="col-sm-2 control-label">Nama Lengkap :</label>
                  <div class="col-sm-7">
                  <input id="nama" class="form-control" value="<?php echo $row->nama_lengkap; ?>" type="text" name="nama" placeholder="Masukkan Nama Pemohon" required>
                </div>
              </div>
              <!-- .form -->
              <div class="form-group col-md-11">
                  ...
                  <div class="col-sm-7">
                  <input id="nik" class="form-control" value="<?php echo $row->nik; ?>" type="number" name="nik" placeholder="Masukkan NIK Pemohon" required>
                </div>
              </div>
              <div class="form-group col-md-11">
              ...
              <div id="transition-components-demo">
                 ...
                 <div class="form-group col-md-11">
                     ...
                     <div class="col-sm-7">
                     <input id="alamat" value="<?php echo $row->alamat_tujuan; ?>" class="form-control" type="text" name="alamat_tujuan" placeholder="Masukkan Alamat Tujuan Pemohon" required>
                   </div>
                 </div>
                 <div class="form-group col-md-11">
                     <label for="dusun" class="col-sm-2 control-label">Dusun Tujuan :</label>
                     <div class="col-sm-7">
                     <input id="dusun" value="<?php echo $row->dusun_tujuan; ?>" class="form-control" type="text" name="dusun" placeholder="Masukkan Alamat Tujuan Pemohon" required>
                   </div>
                 </div>
                 <div class="form-group col-md-11">
                     ...
                     <select class="form-control" id="instansi" name="provinsi">
                       <option value="<?php echo $row->provinsi; ?>" selected disabled><?php echo $row->provinsi; ?></option>
                 ...
                 <div class="form-group col-md-11">
                     ...
                     <select class="form-control" id="instansi" name="kabupaten">
                       <option value="<?php echo $row->kabupaten; ?>" selected disabled><?php echo $row->kabupaten; ?></option>
                 ...
                 <div class="form-group col-md-11">
                     ...
                     <select class="form-control" id="instansi" name="kecamatan">
                       <option value="<?php echo $row->kecamatan; ?>" selected disabled><?php echo $row->kecamatan; ?></option>
                 ...
                 <div class="form-group col-md-11">
                     ...
                     <select class="form-control" id="instansi" name="kel_desa">
                       <option value="<?php echo $row->kel_desa; ?>" selected disabled><?php echo $row->kel_desa; ?></option>
                       <option value="Dayeuhkolot">Dayeuhkolot</option>
                       <option value="Banjaran">Banjaran</option>
                     </select>
                   </div>
                 ...
                 <div class="form-group col-md-11">
                     ...
                     <div class="col-sm-7">
                     <input id="pos" class="form-control" value="<?php echo $row->kode_pos; ?>" type="number" name="kdpos" placeholder="Masukkan Kode POS Tujuan" required>
                   </div>
                 </div>
                 <div class="form-group col-md-11">
                   <label for="datepicker" class="col-sm-2 control-label">Tanggal Kepindahan :</label>
                   <div class="col-sm-7">
                       <input type="text" class="form-control" id="datepicker" value="<?php echo $row->tgl_pindah; ?>" name="tgl" placeholder="Tanggal" required>
                   </div>
                   <!-- /.input group -->
                 </div>
                 <div class="form-group col-md-11">

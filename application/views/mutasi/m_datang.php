...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Data Permohonan Mutasi Penduduk (Masuk)
      <small>index</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="form-horizontal">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-14">
              <!-- Data diri -->
              <form id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url()."Mutasidtg"?>/simpan">
              ...
              <div id="transition-components-demo">
                 ...
                 <div class="form-group col-md-11">
                   ...
                   <div class="col-sm-7">
                       <input type="text" class="form-control" id="datepicker" name="tgl_pindah" placeholder="Tanggal" required>
                   </div>
                   <!-- /.input group -->
                 </div>
                 <div class="form-group col-md-11">
                     ...
                     <select class="form-control" id="klr" name="klr">
                       <option value="a1" selected disabled>-Pilih Klarifikasi Kepindahan-</option>
                 ...
                 <div class="form-group col-md-11">
                     ...
                     <select class="form-control" id="jenis"  name="jenis">
                       <option value="a1" selected disabled>-Pilih Jenis Kepindahan-</option>

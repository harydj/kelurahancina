          ...
          <div class="nav-tabs-custom">
             ...
             <table id="example1" class="table table-bordered table-striped">
               ...
               <tr>
                 ...
                 <td><center>
                                ...
                                <a class='btn btn-info btn-xs' title='Edit Data' href='<?php echo base_url()."Suratblmmenikah/post"?>'><span class='glyphicon glyphicon-edit'></span></a>
           ...
           <!-- /.box-body -->
              ...
              <div class="tab-pane" id="tab_2">
                <form method="post" action="<?php echo base_url()."Suratblmmenikah"?>/simpan">
                    ...
                    <div class="box-body pad">
                      ...
                      <div class="col-md-14">
                        ...
                        <div class="form-group col-md-11">
                            ...
                            <input id="nosrt" name="nosrt" v-model="getMessage" class="form-control" type="number" placeholder="Masukkan No Surat" required><small>KCN/</small><small>{{getMessage}}</small><small>/2/2017</small>
                          </div>
                        </div>

                        <div class="form-group col-md-11">
                            <label for="maksud" class="col-sm-2 control-label">Maksud :</label>
                            <div class="col-sm-7">
                            <input id="maksud" name="maksud" class="form-control" type="text" placeholder="Masukkan Tujuan Surat e.g. Melamar Kerja,.." required>
                          </div>
                        </div>

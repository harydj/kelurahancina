        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-14">
              ...
              <div class="form-group col-md-11">
                  <label for="nama" class="col-sm-2 control-label">Maksud :</label>
                  <div class="col-sm-7">
                  <input id="nama" class="form-control" type="text" placeholder="Masukkan Tujuan Surat e.g. Melamar Kerja,.." required>
                </div>
              </div>
